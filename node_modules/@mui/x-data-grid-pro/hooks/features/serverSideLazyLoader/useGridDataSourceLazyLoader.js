...
var _utils2 = require("../lazyLoader/utils");
...
const useGridDataSourceLazyLoader = (privateApiRef, props) => {
  ...
  const handleScrolling = React.useCallback(newScrollPosition => {
    ...
    const dimensions = (0, _xDataGrid.gridDimensionsSelector)(privateApiRef);
  ...
  const handleRenderedRowsIntervalChange = React.useCallback(params => {
    ...
    const skeletonRowsSection = (0, _utils2.findSkeletonRowsSection)({
